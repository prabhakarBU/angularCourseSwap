...
/*
  router.route("/mscscourses")
  .get(function(req,res,next){
    //create a Course.js in models
    console.log("starting to look for courses");
    Course.find(function(err, courses) {
      if (err) {
        return next(err);
      }
      console.log("done looking for courses " + courses);
...
*/
  router.route("/posts")
    ...
    .post(auth, function(req, res, next) {
      ...
      console.log("printing from router : \n" + post);
      post.upvotes = 1;
      post.locked = false;
